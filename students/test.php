      	...
      	if ($result->num_rows > 0) {
		    ...
		    while($row = $result->fetch_assoc()) {
              ...
              <tr id="section_<?php echo $row['assest_id']; ?>">
                ...
                <td style="width: 70px;"><button id="delb" name="<?php echo $row['assest_id']; ?>" class="btn btn-danger" onclick="deleteThis(this.name,document.getElementById('qtyinput_<?php echo $row['assest_id']; ?>').value);"><span class="fa fa-trash"> </span> </button></td>
              </tr>
        <?php 
      }
		}
