      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="borslip.php"><i class="fa fa-circle-o"></i> Equipment Borrower's Slip</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Equipment Borrower's Slip</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <!-- Form Element sizes -->
          ...
          <div id="txtHint">
                 ...
                 <!-- TABLE-->
               <button type ="button" class = "btn btn-success" data-toggle = "modal" data-target = "#myModal">Add Equip </button>
